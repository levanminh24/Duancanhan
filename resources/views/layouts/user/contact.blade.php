                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="contact-card">
                        ...
                        <div class="contact-content">
                            ...
                            <p class="contact-text">Quốc Oai, Hà Nội</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="contact-card">
                        ...
                        <div class="contact-content">
                            ...
                            <p class="contact-text">
                                <a href="tel:0336345048" class="contact-link">0336345048</a>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="contact-card">
                        ...
                        <div class="contact-content">
                            ...
                            <p class="contact-text">
                                <a href="mailto:info@example.com" class="contact-link">levminh256@gmail.com</a><br>
        ...
        <div class="map-section mb-5">
            <div class="map-container">
                ...
                <div class="map-wrapper">
                    <iframe
  src="https://maps.google.com/maps?q=Quốc+Oai,+Hà+Nội&t=&z=15&ie=UTF8&iwloc=&output=embed"
  width="100%"
  height="300"
