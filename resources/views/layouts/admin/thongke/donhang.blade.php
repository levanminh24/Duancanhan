...
<div class="container-fluid">
    ...
    <div class="row mb-3">
        <div class="col-12">
            ...
            <form class="d-inline-block" action="{{ route('admin.thongke.donhang') }}" method="get">
                <div class="row g-2 align-items-end">
                    <div class="col-auto">
                        <label class="form-label mb-0">Ngày:</label>
                        <input type="date" name="date" value="{{ $dateParam }}" class="form-control form-control-sm" />
                    </div>
                    <div class="col-auto">
                        <label class="form-label mb-0">Tháng:</label>
                        <input type="month" name="month" value="{{ $monthParam }}" class="form-control form-control-sm" />
                    </div>
                    <div class="col-auto">
                        <label class="form-label mb-0">Năm:</label>
                        <input type="number" name="year" value="{{ $yearParam }}" class="form-control form-control-sm" placeholder="YYYY" min="2000" max="2100" />
                    </div>
                    <div class="col-auto">
                        <button type="submit" class="btn btn-sm btn-outline-secondary">Lọc</button>
                        <a href="{{ route('admin.thongke.donhang') }}" class="btn btn-sm btn-link">Xóa lọc</a>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Doanh thu theo tháng ({{ $chartYear }})</h5>
                </div>
                <div class="card-body">
