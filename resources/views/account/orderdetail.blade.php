    ...
    <div class="card-body px-4 py-4">
        <div class="row g-4">
            <div class="col-md-4">
                ...
                <div class="fw-semibold fs-6">{{ $order->name ?? '-' }}</div>
            </div>
            <div class="col-md-4">
                <div class="text-muted small mb-1">Số điện thoại</div>
                <div class="fw-semibold fs-6">{{ $order->phone ?? '-' }}</div>
            </div>
            <div class="col-md-4">
                <div class="text-muted small mb-1">Email</div>
                <div class="fw-semibold fs-6">{{ $order->email ?? '-' }}</div>
            </div>

            <div class="col-12">
                <div class="text-muted small mb-1">Địa chỉ nhận hàng</div>
                <div class="fw-semibold fs-6">{{ $order->address ?? '-' }}</div>
            </div>

            @if(!empty($order->note))
            <div class="col-12">
                <div class="text-muted small mb-1">Ghi chú</div>
                <div class="fst-italic text-secondary">{{ $order->note }}</div>
            </div>
            @endif
